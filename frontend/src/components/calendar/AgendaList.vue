<template>
  <div :class="rootClass">
    ...
    <div
      ...
      :class="scrollable ? 'min-h-0 flex flex-1 flex-col' : ''"
    >
      <div :class="scrollable ? 'custom-scrollbar min-h-0 flex-1 overflow-y-auto' : ''">
...
const rootClass = computed(() => [
  'min-w-0',
  props.scrollable ? 'flex min-h-0 flex-1 flex-col overflow-hidden' : 'flex flex-col',
]);
</script>
