            ...
            <div v-for="b in section.list" :key="b.id"
              ...
              <div class="flex-1 px-4 py-3">
                <div class="flex items-start justify-between gap-2">
                  ...
                  <div v-if="canEditOrCancel(b) || canCancel(b)" class="flex gap-1.5 flex-shrink-0 pt-0.5">
                    <button v-if="canEditOrCancel(b)" @click="handleEdit(b)"
                    ...
                    <button v-if="canCancel(b)" @click="handleCancel(b)"
