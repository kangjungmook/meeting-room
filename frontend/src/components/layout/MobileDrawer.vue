    ...
    <div v-if="showDrawer" class="fixed inset-0 z-50">
      ...
      <div ref="sheetRef"
        ...
        <nav class="flex-shrink-0 px-2 flex flex-col gap-0.5">
          ...
          <button @click="logout"
                  class="flex items-center gap-3 px-4 py-3.5 rounded-xl text-[14px] font-medium text-left w-full transition-colors text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20">
            <svg width="16" height="16" viewBox="0 0 20 20" fill="none" class="flex-shrink-0">
              ...
              <path d="M13 13l4-4-4-4M17 10H8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            로그아웃
          </button>
