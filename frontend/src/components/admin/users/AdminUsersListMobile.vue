      ...
      <div class="flex items-center gap-3 mb-3">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2 flex-wrap">
            ...
            >{{ u.role }}</span>
            <span v-if="u.hasFcmToken" class="flex items-center gap-1 text-[11px] font-semibold text-emerald-500">
              <span class="w-1.5 h-1.5 rounded-full bg-emerald-400"></span>알림
            </span>
          </div>
