      ...
      <table class="w-full">
        <thead>
          <tr class="bg-slate-50 border-b border-slate-100">
            ...
            <th class="text-left px-4 py-3 text-[11px] font-bold text-slate-500 uppercase tracking-wider">알림</th>
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-4 py-3">
              <span v-if="u.hasFcmToken" class="flex items-center gap-1.5 text-[12px] font-bold text-emerald-500">
